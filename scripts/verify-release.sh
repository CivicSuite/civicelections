#!/usr/bin/env bash
set -euo pipefail
echo "VERIFY-RELEASE: CivicElections v0.1.0"
...
import hashlib
expected={"civicelections-0.1.0-py3-none-any.whl","civicelections-0.1.0.tar.gz"}
...
assert civicelections.__version__ == "0.1.0"
